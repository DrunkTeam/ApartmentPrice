...
import os
import skorch
from models import RMSELoss, WrappedNeuralNetRegressor, SimpleNet
...
def log_metadata(cfg, gs, X_train, y_train, X_test, y_test):
    ...
    with mlflow.start_run(run_name = run_name, experiment_id = experiment_id) as run:
        ...
        for index, result in cv_results.iterrows():
            ...
            with mlflow.start_run(run_name = child_run_name, experiment_id= experiment_id, nested=True): #, tags=best_metrics_dict) as child_run:
                ...
                if class_name == "SimpleNet": ###error - change
                    print("YES2")
